#include "rgle/util/Console.h"
	...
	#include <windows.h>
	void rgle::util::Console::coloredPrint(Color color, std::string text)
	{
		if (color != rgle::util::Console::Color::DEFAULT) {
			...
			switch (color) {
			case rgle::util::Console::Color::RED:
				SetConsoleTextAttribute(hConsole,
					0x4 | FOREGROUND_INTENSITY | defaultBackground);
				break;
			case rgle::util::Console::Color::GREEN:
				SetConsoleTextAttribute(hConsole,
					0x2 | FOREGROUND_INTENSITY | defaultBackground);
				break;
			case rgle::util::Console::Color::YELLOW:
				SetConsoleTextAttribute(hConsole,
					0x6 | FOREGROUND_INTENSITY | defaultBackground);
				break;
			case rgle::util::Console::Color::CYAN:
				SetConsoleTextAttribute(hConsole,
