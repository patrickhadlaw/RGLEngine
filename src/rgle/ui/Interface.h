...
namespace rgle::ui {
	...
	class Element : public gfx::Renderable, public Raycastable, public BoundingBox, public EventListener {
	public:
		Element();
	...
	class Layer : public gfx::RenderLayer, public EventListener {
	public:
	...
	class RectElement : public Element, public gfx::Geometry3D {
	public:
		RectElement();
		...
		void changeColor(util::Fill fill);
	...
	struct BasicButtonAttributes {
		...
		util::Fill defaultColor = util::Fill(glm::vec4(0.9, 0.9, 0.9, 1.0));
		util::Fill hoverColor = util::Fill(glm::vec4(0.75, 0.75, 0.75, 1.0));
		util::Fill activeColor = util::Fill(glm::vec4(0.5, 0.5, 0.5, 1.0));
		util::Fill fontColor;
	};
